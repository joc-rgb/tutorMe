...
const Home: NextPage = () => {
  ...
  return (
    <div className='w-full min-h-100vh items-center' >
      ...
      <Hero/>
        <p className="font-semibold">All Postings</p>
        {loading && 
        <svg aria-hidden="true" className="w-48 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {!loading&&data.posts.edges.map(({node}: { node: Post })=><DataCard key={node.id} data={node}/>)}
