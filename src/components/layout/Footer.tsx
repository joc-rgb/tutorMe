...
<footer className="p-4 bg-white border-t-2 b-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 ">
    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {new Date().getFullYear()} <a href="https://github.com/joc-rgb" className="hover:underline">Jocelin RGB</a>
    </span>
